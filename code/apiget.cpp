    ...
    ui(new Ui::APIGet)
{
    ...
    // 将折线图添加到界面布局中
    ui->verticalLayout->addWidget(lineChartWidget);
}
...
{
    if(ui->Button_openserial->text() == "openPort")
    {
...
//        ui->label_light->setStyleSheet("background-color:rgb(255,0,0);border-radius:5px;");
        ...
        ui->Button_openserial->setText(tr("openPort"));
    }
}
...
void APIGet::on_Button_send_clicked()
{
    if (serial->isOpen())
    {
