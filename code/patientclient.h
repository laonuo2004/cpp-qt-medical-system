...
private:
    ...
    class PayInterface* m_patientPayWidget ;
    class ChatInterface* m_patientChatWIdget ;
    class APIGet* m_patientDataWidget ;
    class MedicineSearchFunc* m_patientDrugWidget;
    class MedicalHistoryFunc* m_patientMedicalHistoryWidget;
